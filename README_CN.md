...
43 频道、约 5 万条消息、1900+ threads 规模下，端到端跑完约 5–10 分钟；产出 ~96 MB HTML + ~70 MB JSON。
...
│   ├── General/
│   │   ├── general.html
│   │   ├── help-desk_threads/  ← forum 频道：只有 threads
│   │   └── ...
│   ├── Terminal-Bench/
│   │   ├── tb-3.html
│   │   ├── tb-3_threads/
...
| Forum 频道看起来"空" | `help-desk.html` 之类的找不到 | 在汇报里说明这是 Forum 频道，内容在 threads/ 子目录里 |
